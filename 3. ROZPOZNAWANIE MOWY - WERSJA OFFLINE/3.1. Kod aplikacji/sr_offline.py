...
class Program(QWidget):
    ...
    def init_ui(self):
        ...
        h2_layout.addWidget(self.playButton)
        h2_layout.addWidget(self.stopButton)
        ...
        h3_layout.addWidget(self.openTextButton)
        h3_layout.addWidget(self.saveTextButton)
        ...
        self.setWindowTitle("Speech Recognition - offline")
        self.resize(325, 500)
        self.center()
        self.show()
